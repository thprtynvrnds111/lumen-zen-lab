      ...
      <main>
        ...
        <section className="px-6 md:px-12 lg:px-20 pb-16">
          <div className="max-w-3xl mx-auto space-y-8">
            ...
            <p className="text-foreground/80 leading-relaxed">
              We live in a culture addicted to intensity. Harder workouts. Louder affirmations. More aggressive protocols. But the body doesn't heal in intensity. It heals in safety. Microcurrent operates below the threshold of sensation — 400 microamps, invisible to the conscious mind but deeply legible to the cell.
            </p>
            ...
            <p className="text-foreground/80 leading-relaxed">
              There's a lesson in that for how we approach everything — boundaries, self-worth, sleep, healing. The most durable changes are the ones that arrive without force. The ones that accumulate so gradually you don't notice until one morning you catch your reflection and something is different. Not your face. Your presence.
            </p>
