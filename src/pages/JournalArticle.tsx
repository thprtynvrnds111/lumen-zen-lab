   ...
   <main>
    ...
    <section className="py-20 md:py-28 px-6 md:px-12 lg:px-20">
     <div className="max-w-3xl mx-auto">
      <Link to="/journal" className="text-xs tracking-[0.25em] uppercase text-[#0E7A54] hover:text-[#1BAF86] transition-colors mb-8 inline-block">
       ← Back to Journal
      </Link>
      <p className="text-xs tracking-[0.25em] uppercase text-[#8E8E8E] mb-4 mt-6">Ritual · Deep Practice</p>
      ...
      <div className="flex items-center gap-4 text-sm text-[#8E8E8E] mb-4">
       <span>February 16, 2026</span>
       <span className="w-1 h-1 rounded-full bg-[rgba(20,20,20,0.25)]" />
    ...
    <section className="px-6 md:px-12 lg:px-20 pb-16">
     <div className="max-w-3xl mx-auto space-y-8">
      ...
      <blockquote className="border-l border-[#0E7A54] pl-6 py-2 my-10">
       <p className="font-sans font-light tracking-[-0.025em] text-xl md:text-2xl text-[#141414] leading-relaxed">
      ...
      <h2 className="text-2xl font-light tracking-[-0.025em] text-[#141414] pt-4">The Body Knows Before the Mind Agrees</h2>
      ...
      {/* Identity vs. Outcome */}
      <div className="bg-white border border-[rgba(20,20,20,0.10)] rounded-none p-8 md:p-10 my-12">
       <p className="text-xs tracking-[0.2em] uppercase text-[#8E8E8E] mb-4">Reflection</p>
       <h2 className="text-2xl font-light tracking-[-0.025em] text-[#141414] mb-4">Identity Over Outcome</h2>
       <p className="text-[#141414]/80 leading-relaxed mb-4">
       ...
       <p className="text-[#141414]/80 leading-relaxed">
        The ritual rewires identity. Not through affirmation, but through repetition. Every evening I choose five minutes of stillness over five minutes of scrolling, I am casting a vote for a version of myself that trusts slowness. That believes gentleness is not weakness. That knows the most powerful thing I can do for my nervous system is <span className="italic">nothing at all</span>, held with intention.
       </p>
      </div>

      {/* Embodiment */}
      <h2 className="text-2xl font-light tracking-[-0.025em] text-[#141414] pt-4">What Embodiment Actually Feels Like</h2>
      ...
      <p className="text-[#141414]/80 leading-relaxed">
       I've started thinking of my evening ritual not as skincare, but as a form of self-trust. Every night I return to it, I am saying: <span className="italic">I am worth this pause. I am worth this attention. I am worth the slow, unglamorous work of becoming.</span>
      </p>
      ...
      {/* Quiet Power */}
      <h2 className="text-2xl font-light tracking-[-0.025em] text-[#141414] pt-4">The Quiet Power of Low Frequency</h2>
      ...
      {/* Ritual Steps */}
      <div className="bg-white border border-[rgba(20,20,20,0.10)] rounded-none p-8 md:p-10 my-12">
       <p className="text-xs tracking-[0.2em] uppercase text-[#8E8E8E] mb-4">Anchor Ritual</p>
       <h2 className="text-2xl font-light tracking-[-0.025em] text-[#141414] mb-6">Tonight's Practice: The Frequency Reset</h2>
       <p className="text-[#141414]/80 leading-relaxed mb-8">
       ...
       <div className="space-y-6">
        <div className="flex gap-5 items-start">
         <div className="w-10 h-10 rounded-full border border-[rgba(20,20,20,0.15)] flex items-center justify-center text-sm font-semibold text-[#0E7A54] shrink-0">01</div>
         <div>
          <h3 className="font-medium text-[#141414] mb-1">Arrive: 3 Breaths at the Threshold</h3>
          <p className="text-sm text-[#5A5A5A] leading-relaxed">Before you touch the device, stand at the bathroom door. Three breaths. Inhale through the nose for 4 counts. Exhale through the mouth for 6. This isn't preparation, this is the ritual beginning. You are crossing from doing into being.</p>
         </div>
        </div>

        <div className="flex gap-5 items-start">
         <div className="w-10 h-10 rounded-full border border-[rgba(20,20,20,0.15)] flex items-center justify-center text-sm font-semibold text-[#0E7A54] shrink-0">02</div>
         <div>
          <h3 className="font-medium text-[#141414] mb-1">Light: Bathe Before You Touch</h3>
          <p className="text-sm text-[#5A5A5A] leading-relaxed">Turn on the red light mode. Hold the device 2-3 inches from your face. Close your eyes. Let the warmth reach you before the current does. 60 seconds. Feel the amber glow through your eyelids. This is the body's invitation to downregulate.</p>
         </div>
        </div>

        <div className="flex gap-5 items-start">
         <div className="w-10 h-10 rounded-full border border-[rgba(20,20,20,0.15)] flex items-center justify-center text-sm font-semibold text-[#0E7A54] shrink-0">03</div>
         <div>
          <h3 className="font-medium text-[#141414] mb-1">Glide: Follow the Jaw, Release the Day</h3>
          <p className="text-sm text-[#5A5A5A] leading-relaxed">Apply conductive gel. Begin at the jawline, where we hold tension, words unsaid, decisions unmade. Glide upward along the natural contours. Slow. Slower than you think. Let each stroke be a sentence you're writing to your future self: <span className="italic">I am not in a rush to become.</span></p>
         </div>
        </div>

        <div className="flex gap-5 items-start">
         <div className="w-10 h-10 rounded-full border border-[rgba(20,20,20,0.15)] flex items-center justify-center text-sm font-semibold text-[#0E7A54] shrink-0">04</div>
         <div>
          <h3 className="font-medium text-[#141414] mb-1">Stillness: Hold at the Temples</h3>
          <p className="text-sm text-[#5A5A5A] leading-relaxed">Rest the device at both temples. Don't move. Breathe. This is the integration point, where electrical frequency meets emotional frequency. 90 seconds of nothing. Notice what arises without narrating it. This is where self-trust is built: in the willingness to stay.</p>
         </div>
        </div>

        <div className="flex gap-5 items-start">
         <div className="w-10 h-10 rounded-full border border-[rgba(20,20,20,0.15)] flex items-center justify-center text-sm font-semibold text-[#0E7A54] shrink-0">05</div>
         <div>
          <h3 className="font-medium text-[#141414] mb-1">Close: One Whispered Word</h3>
          <p className="text-sm text-[#5A5A5A] leading-relaxed">As you set the device down, choose one word. Not a mantra. Not an affirmation. A word that describes the version of you that just spent five minutes in sacred stillness. Carry it to sleep. Let it dissolve into the body overnight. Tomorrow, you'll wake up slightly different. Not because you forced it, because you allowed it.</p>
         </div>
        </div>
       </div>
      </div>
      ...
      <div className="text-center py-8">
       ...
       <p className="font-sans font-light tracking-[-0.025em] text-xl md:text-2xl text-[#141414] leading-relaxed max-w-xl mx-auto">
       ...
       <p className="text-xs tracking-[0.2em] uppercase text-[#8E8E8E] mt-6">
        A Zential Evening
       </p>
      </div>
     </div>
