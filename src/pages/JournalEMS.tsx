   ...
   <main>
    <section className="py-20 md:py-28 px-6 md:px-12 lg:px-20">
     <div className="max-w-3xl mx-auto">
      ...
      <p className="text-xs tracking-[0.25em] uppercase text-[#8E8E8E] mb-4 mt-6">Science · Technology</p>
    ...
    <section className="px-6 md:px-12 lg:px-20 pb-16">
     <div className="max-w-3xl mx-auto space-y-8">
      ...
      <h2 className="text-2xl font-light tracking-[-0.025em] text-[#141414] pt-4">The Amplitude Divide</h2>
      ...
      <div className="bg-white border border-[rgba(20,20,20,0.10)] rounded-none p-8 md:p-10 my-12">
       <p className="text-xs tracking-[0.2em] uppercase text-[#8E8E8E] mb-4">Comparison</p>
       <h2 className="text-2xl font-light tracking-[-0.025em] text-[#141414] mb-6">Key Differences at a Glance</h2>
       <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <div className="space-y-4">
         <h3 className="font-medium text-[#141414]">EMS (Milliamps)</h3>
         <div className="space-y-2 text-sm text-[#141414]/80">
          <div className="flex gap-3 items-start">
           <div className="w-2 h-2 rounded-full bg-[#0E7A54] mt-1.5 shrink-0" />
        ...
        <div className="space-y-4">
         <h3 className="font-medium text-[#141414]">Microcurrent (Microamps)</h3>
         <div className="space-y-2 text-sm text-[#141414]/80">
          <div className="flex gap-3 items-start">
           <div className="w-2 h-2 rounded-full bg-[#2ED8A8] mt-1.5 shrink-0" />
      ...
      <h2 className="text-2xl font-light tracking-[-0.025em] text-[#141414] pt-4">What EMS Does Well</h2>
      ...
      <h2 className="text-2xl font-light tracking-[-0.025em] text-[#141414] pt-4">What Microcurrent Does Differently</h2>
      ...
      <h2 className="text-2xl font-light tracking-[-0.025em] text-[#141414] pt-4">The Case for Both</h2>
    ...
    <JournalRelatedArticles currentSlug="/journal/ems-vs-microcurrent" />
    <NewsletterSection />
   </main>
   <ZentialFooter />
  </div>
