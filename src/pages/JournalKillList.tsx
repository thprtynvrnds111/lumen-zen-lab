      ...
      <main>
        ...
        <section className="px-6 md:px-12 lg:px-20 pb-16">
          <div className="max-w-3xl mx-auto space-y-8">
            ...
            <p className="text-foreground/80 leading-relaxed">Fewer things, described exactly.</p>
            ...
            <h2 className="text-2xl font-bold text-foreground pt-4">What this list is</h2>
            <p className="text-foreground/80 leading-relaxed">
