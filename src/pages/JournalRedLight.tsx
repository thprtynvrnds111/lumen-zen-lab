   ...
   <main>
    <section className="py-20 md:py-28 px-6 md:px-12 lg:px-20">
     <div className="max-w-3xl mx-auto">
      ...
      <p className="text-xs tracking-[0.25em] uppercase text-[#8E8E8E] mb-4 mt-6">Research · Clinical Review</p>
    ...
    <section className="px-6 md:px-12 lg:px-20 pb-16">
     <div className="max-w-3xl mx-auto space-y-8">
      ...
      <h2 className="text-2xl font-light tracking-[-0.025em] text-[#141414] pt-4">The Physics of Photobiomodulation</h2>
      ...
      <div className="bg-white border border-[rgba(20,20,20,0.10)] rounded-none p-8 md:p-10 my-12">
       <p className="text-xs tracking-[0.2em] uppercase text-[#8E8E8E] mb-4">Study Review</p>
       <h2 className="text-2xl font-light tracking-[-0.025em] text-[#141414] mb-4">Skin Rejuvenation: The Wunsch & Matuschka Trial</h2>
      ...
      <h2 className="text-2xl font-light tracking-[-0.025em] text-[#141414] pt-4">Wound Healing and Tissue Repair</h2>
      ...
      <h2 className="text-2xl font-light tracking-[-0.025em] text-[#141414] pt-4">Inflammation and Rosacea</h2>
      ...
      <h2 className="text-2xl font-light tracking-[-0.025em] text-[#141414] pt-4">Dosimetry: Why Parameters Matter</h2>
      ...
      <div className="bg-white border border-[rgba(20,20,20,0.10)] rounded-none p-8 md:p-10 my-12">
       <p className="text-xs tracking-[0.2em] uppercase text-[#8E8E8E] mb-4">Evidence Summary</p>
       <h2 className="text-2xl font-light tracking-[-0.025em] text-[#141414] mb-6">What We Know, What We Don't</h2>
       <div className="space-y-4">
        <div>
         <h3 className="font-medium text-[#141414] mb-2">Strong Evidence</h3>
         <div className="space-y-2">
          <div className="flex gap-4 items-start">
           <div className="w-2 h-2 rounded-full bg-[#2ED8A8] mt-2 shrink-0" />
           <p className="text-[#141414]/80 leading-relaxed">Accelerated wound healing and tissue repair through fibroblast stimulation</p>
          </div>
          <div className="flex gap-4 items-start">
           <div className="w-2 h-2 rounded-full bg-[#2ED8A8] mt-2 shrink-0" />
           <p className="text-[#141414]/80 leading-relaxed">Increased collagen density in dermis with consistent use over 8+ weeks</p>
          </div>
          <div className="flex gap-4 items-start">
           <div className="w-2 h-2 rounded-full bg-[#2ED8A8] mt-2 shrink-0" />
           <p className="text-[#141414]/80 leading-relaxed">Enhanced mitochondrial ATP production via cytochrome c oxidase activation</p>
          </div>
         </div>
        </div>
        <div className="mt-6">
         <h3 className="font-medium text-[#141414] mb-2">Promising but Preliminary</h3>
         <div className="space-y-2">
          <div className="flex gap-4 items-start">
           <div className="w-2 h-2 rounded-full bg-[#0E7A54] mt-2 shrink-0" />
           <p className="text-[#141414]/80 leading-relaxed">Anti-inflammatory effects for rosacea and chronic erythema</p>
          </div>
          <div className="flex gap-4 items-start">
           <div className="w-2 h-2 rounded-full bg-[#0E7A54] mt-2 shrink-0" />
           <p className="text-[#141414]/80 leading-relaxed">Pigmentation regulation and melanin pathway modulation</p>
          </div>
          <div className="flex gap-4 items-start">
           <div className="w-2 h-2 rounded-full bg-[#0E7A54] mt-2 shrink-0" />
           <p className="text-[#141414]/80 leading-relaxed">Synergistic effects when combined with microcurrent therapy</p>
          </div>
         </div>
        </div>
       </div>
      ...
      <h2 className="text-2xl font-light tracking-[-0.025em] text-[#141414] pt-4">The Zential Perspective</h2>
    ...
    <JournalRelatedArticles currentSlug="/journal/red-light-clinical" />
    <NewsletterSection />
   </main>
   <ZentialFooter />
  </div>
