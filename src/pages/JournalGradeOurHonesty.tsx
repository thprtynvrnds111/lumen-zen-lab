        ...
        <section className="px-6 md:px-12 lg:px-20 pb-16">
          <div className="max-w-3xl mx-auto space-y-8">
            ...
            <div className="space-y-6">
              <div className="border-l border-[#0E7A54] pl-6">
                <p className="font-medium text-[#141414] mb-2">
              ...
              <div className="border-l border-[#0E7A54] pl-6">
                <p className="font-medium text-[#141414] mb-2">Microcurrent.</p>
                <p className="text-[#141414]/80 leading-relaxed">
              ...
              <div className="border-l border-[#0E7A54] pl-6">
                <p className="font-medium text-[#141414] mb-2">Thermal (warming).</p>
                <p className="text-[#141414]/80 leading-relaxed">
            ...
            <h2 className="text-2xl font-light tracking-[-0.025em] text-[#141414] pt-4">The guarantee, restated</h2>
            <p className="text-[#141414]/80 leading-relaxed">
            ...
            <h2 className="text-2xl font-light tracking-[-0.025em] text-[#141414] pt-4">The invitation</h2>
            <p className="text-[#141414]/80 leading-relaxed">
            ...
            <p className="text-[#141414]/80 leading-relaxed">Then tell us where we lied.</p>
            <p className="text-[#141414]/80 leading-relaxed">
            ...
            <div className="bg-white border border-[rgba(20,20,20,0.10)] rounded-none p-8 my-8">
              <p className="text-[#141414]/90 leading-relaxed">
                <strong>Email:</strong>{" "}
                <a
                  href="mailto:info@zentialpure.com?subject=Grade"
                  className="underline underline-offset-4 text-[#0E7A54] hover:text-[#1BAF86] transition-colors"
                >
              ...
              <p className="text-[#141414]/80 leading-relaxed mt-4">
