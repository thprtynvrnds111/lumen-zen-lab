   ...
   <main>
    <section className="py-20 md:py-28 px-6 md:px-12 lg:px-20">
     <div className="max-w-3xl mx-auto">
      ...
      <p className="text-xs tracking-[0.25em] uppercase text-[#8E8E8E] mb-4 mt-6">Wellness · Body Intelligence</p>
    ...
    <section className="px-6 md:px-12 lg:px-20 pb-16">
     <div className="max-w-3xl mx-auto space-y-8">
      ...
      <h2 className="text-2xl font-light tracking-[-0.025em] text-[#141414] pt-4">The Invisible Architecture</h2>
      ...
      <div className="bg-white border border-[rgba(20,20,20,0.10)] rounded-none p-8 md:p-10 my-12">
       <p className="text-xs tracking-[0.2em] uppercase text-[#8E8E8E] mb-4">The Science</p>
       <h2 className="text-2xl font-light tracking-[-0.025em] text-[#141414] mb-4">How Microcurrent Supports Lymphatic Flow</h2>
      ...
      <h2 className="text-2xl font-light tracking-[-0.025em] text-[#141414] pt-4">Sculpting Through Subtraction</h2>
      ...
      <h2 className="text-2xl font-light tracking-[-0.025em] text-[#141414] pt-4">The Morning Protocol for Drainage</h2>
      ...
      <div className="bg-white border border-[rgba(20,20,20,0.10)] rounded-none p-8 md:p-10 my-12">
       <p className="text-xs tracking-[0.2em] uppercase text-[#8E8E8E] mb-4">Morning Practice</p>
       <h2 className="text-2xl font-light tracking-[-0.025em] text-[#141414] mb-6">The 3-Minute Drainage Sequence</h2>
       ...
       <div className="space-y-6">
        <div className="flex gap-5 items-start">
         ...
         <div>
          <h3 className="font-medium text-[#141414] mb-1">Open the Gates (30 seconds)</h3>
          <p className="text-sm text-[#5A5A5A] leading-relaxed">Before touching the face, glide the device gently down each side of the neck from ear to collarbone. This opens the supraclavicular drainage point and creates space for the fluid you're about to move downward.</p>
         </div>
        </div>
        ...
        <div className="flex gap-5 items-start">
         ...
         <div>
          <h3 className="font-medium text-[#141414] mb-1">Under-Eye Sweep (60 seconds)</h3>
          <p className="text-sm text-[#5A5A5A] leading-relaxed">Using the lowest intensity, glide from the inner corner of the eye outward toward the temple, then down to the preauricular node in front of the ear. Featherlight. The lymphatic vessels here are as thin as spider silk. They respond to suggestion, not force.</p>
         </div>
        </div>
        ...
        <div className="flex gap-5 items-start">
         ...
         <div>
          <h3 className="font-medium text-[#141414] mb-1">Jawline Definition (60 seconds)</h3>
          <p className="text-sm text-[#5A5A5A] leading-relaxed">Glide from the chin along the jawline to the ear, then sweep down the neck to the collarbone. Repeat 5 times on each side. This is where most morning puffiness accumulates, and where the most visible sculpting effect occurs.</p>
         </div>
        </div>
        ...
        <div className="flex gap-5 items-start">
         ...
         <div>
          <h3 className="font-medium text-[#141414] mb-1">Close the Circuit (30 seconds)</h3>
          <p className="text-sm text-[#5A5A5A] leading-relaxed">Finish with three slow neck sweeps on each side, ear to collarbone. Take a breath. Notice the difference. The face you see now is the face that was always there, just waiting to be uncovered.</p>
         </div>
        </div>
       </div>
      </div>

      <h2 className="text-2xl font-light tracking-[-0.025em] text-[#141414] pt-4">Beyond Aesthetics</h2>
    ...
    <JournalRelatedArticles currentSlug="/journal/lymphatic-drainage" />
    <NewsletterSection />
   </main>
   <ZentialFooter />
  </div>
