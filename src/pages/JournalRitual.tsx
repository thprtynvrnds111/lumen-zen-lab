   ...
   <main>
    <section className="py-20 md:py-28 px-6 md:px-12 lg:px-20">
     <div className="max-w-3xl mx-auto">
      ...
      <p className="text-xs tracking-[0.25em] uppercase text-[#8E8E8E] mb-4 mt-6">Ritual · Evening Practice</p>
    ...
    <section className="px-6 md:px-12 lg:px-20 pb-16">
     <div className="max-w-3xl mx-auto space-y-8">
      ...
      <h2 className="text-2xl font-light tracking-[-0.025em] text-[#141414] pt-4">Why the Evening Matters</h2>
      ...
      <div className="bg-white border border-[rgba(20,20,20,0.10)] rounded-none p-8 md:p-10 my-12">
       <p className="text-xs tracking-[0.2em] uppercase text-[#8E8E8E] mb-4">The Protocol</p>
       <h2 className="text-2xl font-light tracking-[-0.025em] text-[#141414] mb-6">Your 5-Minute Evening Sequence</h2>
       ...
       <div className="space-y-6">
        <div className="flex gap-5 items-start">
         ...
         <div>
          <h3 className="font-medium text-[#141414] mb-1">Transition (30 seconds)</h3>
          <p className="text-sm text-[#5A5A5A] leading-relaxed">Put your phone in another room. Not on silent, not face down. In another room. Stand at your bathroom mirror and take three slow breaths. This isn't meditation. This is just a doorway. You're crossing from performance into presence.</p>
         </div>
        </div>
        ...
        <div className="flex gap-5 items-start">
         ...
         <div>
          <h3 className="font-medium text-[#141414] mb-1">Cleanse (60 seconds)</h3>
          <p className="text-sm text-[#5A5A5A] leading-relaxed">Warm water. A gentle cleanser. Move slowly. Feel the temperature on your skin. This isn't about removing the day's dirt; it's about acknowledging the day happened. Every stroke is a small act of closure.</p>
         </div>
        </div>
        ...
        <div className="flex gap-5 items-start">
         ...
         <div>
          <h3 className="font-medium text-[#141414] mb-1">Apply Conductive Gel (30 seconds)</h3>
          <p className="text-sm text-[#5A5A5A] leading-relaxed">A thin, even layer across the cheeks, jawline, and forehead. The gel serves two purposes: it enhances microcurrent conductivity, and the cool, smooth texture is itself a sensory cue that downregulates the nervous system.</p>
         </div>
        </div>
        ...
        <div className="flex gap-5 items-start">
         ...
         <div>
          <h3 className="font-medium text-[#141414] mb-1">Microcurrent Glide (2 minutes)</h3>
          <p className="text-sm text-[#5A5A5A] leading-relaxed">Begin at the jawline. Glide upward along the natural contours of the face: jaw to cheekbone, cheekbone to temple, forehead center to hairline. Each stroke should take 3 to 4 seconds. No pressure. The current does the work. Your only job is to move slowly and breathe.</p>
         </div>
        </div>
        ...
        <div className="flex gap-5 items-start">
         ...
         <div>
          <h3 className="font-medium text-[#141414] mb-1">Red Light Hold (60 seconds)</h3>
          <p className="text-sm text-[#5A5A5A] leading-relaxed">Switch to red light mode. Hold the device 2 inches from your face. Close your eyes. The 660nm wavelength penetrates the dermis, supporting mitochondrial function and collagen synthesis. But right now, you don't need to think about any of that. Just feel the warmth. Let it be enough.</p>
         </div>
        </div>
       </div>
      </div>

      <h2 className="text-2xl font-light tracking-[-0.025em] text-[#141414] pt-4">What Happens When You Stop Negotiating</h2>
      ...
      <h2 className="text-2xl font-light tracking-[-0.025em] text-[#141414] pt-4">Adapting Without Abandoning</h2>
    ...
    <JournalRelatedArticles currentSlug="/journal/evening-protocol" />
    <NewsletterSection />
   </main>
   <ZentialFooter />
  </div>
