...
function WaitlistForm({ compact }: { compact?: boolean }) {
  ...
  if (state === "done") {
    return (
      <div className="border border-[#0E7A54]/40 bg-[#F4FBF8] p-6 max-w-md">
        <p className="font-sans text-xs font-medium tracking-[0.22em] uppercase text-[#141414] mb-2">
          You are on the list
        </p>
  ...
  return (
    <form onSubmit={submit} className={`flex flex-col sm:flex-row gap-4 ${compact ? "" : "max-w-md"}`}>
      <input
        ...
        className="flex-1 bg-white border border-[rgba(20,20,20,0.20)] px-4 py-3 text-sm text-[#141414] placeholder:text-[#8E8E8E] focus:border-[#0E7A54] focus:outline-none"
      />
      <button
        type="submit"
        disabled={state === "sending"}
        className="rounded-full bg-[#2ED8A8] text-[#141414] px-8 py-3 font-sans text-xs font-semibold tracking-[0.22em] uppercase hover:bg-[#1BAF86] transition-colors disabled:opacity-60"
      >
  ...
  return (
    ...
    >
      ...
      <section className="px-6 md:px-12 lg:px-20 pt-10">
        <div className="max-w-3xl mx-auto border border-[rgba(20,20,20,0.10)] bg-white p-6">
          <p className="font-sans text-[11px] font-medium tracking-[0.22em] uppercase text-[#8E8E8E] leading-relaxed">
      ...
      <section className="px-6 md:px-12 lg:px-20 pt-16 pb-12">
        <div className="max-w-3xl mx-auto">
          <p className="font-sans text-xs font-medium tracking-[0.22em] uppercase text-[#8E8E8E] mb-8">
            The Restoration Wrap
          </p>
          <h1
            className="font-sans font-light tracking-[-0.03em] leading-[1.02] text-[#141414]"
            style={{ fontSize: "clamp(2.5rem, 6vw, 4.5rem)" }}
          >
            A whole-body heat wrap. Proposed. Not built yet.
          </h1>
          <p className="mt-8 text-lg text-[#5A5A5A] leading-relaxed max-w-2xl">
          ...
          <p className="mt-4 text-lg text-[#5A5A5A] leading-relaxed">It does not exist yet.</p>
          <p className="mt-4 text-lg text-[#5A5A5A] leading-relaxed">
            We will build it if enough of you join the waitlist below.
          </p>
          <p className="mt-8 text-base text-[#141414]">
            <span className="font-semibold">Target price: $299 / €279</span>{" "}
            <span className="text-[#8E8E8E]">(target — final price confirmed at build decision)</span>
          </p>
          <div className="mt-8">
            <WaitlistForm />
          </div>
      ...
      {/* MECHANISM */}
      <section className="px-6 md:px-12 lg:px-20 py-16 border-t border-[rgba(20,20,20,0.10)]">
        <div className="max-w-3xl mx-auto space-y-8">
          <p className="font-sans text-xs font-medium tracking-[0.22em] uppercase text-[#8E8E8E]">
          ...
          <h2 className="font-sans font-light tracking-[-0.025em] text-2xl text-[#141414] pt-4">
            Three design choices that follow from the mechanism
          </h2>
          <div className="space-y-6">
            <div className="border-l-2 border-[rgba(20,20,20,0.15)] pl-6">
              <p className="font-semibold text-[#141414] mb-2">1. Whole-body, not local.</p>
              <p className="text-[#5A5A5A] leading-relaxed">
            ...
            <div className="border-l-2 border-[rgba(20,20,20,0.15)] pl-6">
              <p className="font-semibold text-[#141414] mb-2">2. Sustained, not pulsed.</p>
              <p className="text-[#5A5A5A] leading-relaxed">
            ...
            <div className="border-l-2 border-[rgba(20,20,20,0.15)] pl-6">
              <p className="font-semibold text-[#141414] mb-2">3. Conductive, not convective.</p>
              <p className="text-[#5A5A5A] leading-relaxed">
      ...
      <section className="px-6 md:px-12 lg:px-20 py-16 border-t border-[rgba(20,20,20,0.10)] bg-white">
        <div className="max-w-3xl mx-auto space-y-8">
          <p className="font-sans text-xs font-medium tracking-[0.22em] uppercase text-[#8E8E8E]">
          ...
          <p className="text-[#5A5A5A] leading-relaxed">
            ...
            <a
              ...
              className="underline underline-offset-4 hover:text-[#0E7A54]"
            >
          ...
          <ul className="space-y-4 text-[#5A5A5A] leading-relaxed list-none">
            <li className="border-l-2 border-[rgba(20,20,20,0.15)] pl-6">
      ...
      <section className="px-6 md:px-12 lg:px-20 py-16 border-t border-[rgba(20,20,20,0.10)]">
        <div className="max-w-3xl mx-auto space-y-8">
          ...
          <div className="bg-white border border-[rgba(20,20,20,0.10)] p-8">
            <p className="font-sans text-xs font-medium tracking-[0.22em] uppercase text-[#8E8E8E] mb-4">
              A typical session
            </p>
            <ul className="space-y-2 text-[#5A5A5A] leading-relaxed">
      ...
      {/* WAITLIST CTA */}
      <section className="px-6 md:px-12 lg:px-20 py-16 border-t border-[rgba(20,20,20,0.10)] bg-[#F4FBF8]">
        <div className="max-w-3xl mx-auto space-y-8">
          <h2 className="font-sans font-light tracking-[-0.025em] text-3xl text-[#141414]">
          ...
          <div className="grid md:grid-cols-2 gap-8">
            <div>
              ...
              <ul className="space-y-2 text-[#5A5A5A] text-sm leading-relaxed">
          ...
          <p className="text-sm text-[#8E8E8E] leading-relaxed">
            <strong className="text-[#141414]">We will not email you more than twice</strong> —
