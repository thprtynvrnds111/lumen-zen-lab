   ...
   <main>
    <section className="py-20 md:py-28 px-6 md:px-12 lg:px-20">
     <div className="max-w-3xl mx-auto">
      ...
      <p className="text-xs tracking-[0.25em] uppercase text-[#8E8E8E] mb-4 mt-6">Science · Cellular Biology</p>
    ...
    <section className="px-6 md:px-12 lg:px-20 pb-16">
     <div className="max-w-3xl mx-auto space-y-8">
      ...
      <h2 className="text-2xl font-light tracking-[-0.025em] text-[#141414] pt-4">The Bioelectrical Foundation</h2>
      ...
      <div className="bg-white border border-[rgba(20,20,20,0.10)] rounded-none p-8 md:p-10 my-12">
       <p className="text-xs tracking-[0.2em] uppercase text-[#8E8E8E] mb-4">Clinical Data</p>
       <h2 className="text-2xl font-light tracking-[-0.025em] text-[#141414] mb-4">The ATP Effect</h2>
      ...
      <h2 className="text-2xl font-light tracking-[-0.025em] text-[#141414] pt-4">Fibroblast Activation and Collagen Synthesis</h2>
      ...
      <h2 className="text-2xl font-light tracking-[-0.025em] text-[#141414] pt-4">The Wound Healing Parallel</h2>
      ...
      <h2 className="text-2xl font-light tracking-[-0.025em] text-[#141414] pt-4">Frequency, Duration, and Consistency</h2>
      ...
      <div className="bg-white border border-[rgba(20,20,20,0.10)] rounded-none p-8 md:p-10 my-12">
       <p className="text-xs tracking-[0.2em] uppercase text-[#8E8E8E] mb-4">Key Takeaways</p>
       <h2 className="text-2xl font-light tracking-[-0.025em] text-[#141414] mb-6">What the Science Actually Tells Us</h2>
       <div className="space-y-4">
        <div className="flex gap-4 items-start">
         <div className="w-2 h-2 rounded-full bg-[#2ED8A8] mt-2 shrink-0" />
         <p className="text-[#141414]/80 leading-relaxed">Microcurrent at 500 microamps increases cellular ATP production by up to 500%, fueling collagen synthesis at the source.</p>
        </div>
        <div className="flex gap-4 items-start">
         <div className="w-2 h-2 rounded-full bg-[#2ED8A8] mt-2 shrink-0" />
         <p className="text-[#141414]/80 leading-relaxed">Higher currents actually decrease ATP, confirming that subtlety outperforms intensity at the cellular level.</p>
        </div>
        <div className="flex gap-4 items-start">
         <div className="w-2 h-2 rounded-full bg-[#2ED8A8] mt-2 shrink-0" />
         <p className="text-[#141414]/80 leading-relaxed">Fibroblasts respond to bioelectrical entrainment by resuming collagen production naturally, without external growth factors.</p>
        </div>
        <div className="flex gap-4 items-start">
         <div className="w-2 h-2 rounded-full bg-[#2ED8A8] mt-2 shrink-0" />
         <p className="text-[#141414]/80 leading-relaxed">Consistency matters more than intensity. Daily 5-minute sessions produce cumulative dermal remodeling over weeks.</p>
        </div>
       </div>
      </div>
