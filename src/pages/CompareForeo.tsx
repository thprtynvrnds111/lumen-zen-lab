     ...
     <div className="max-w-2xl mx-auto">
      ...
      <div className="space-y-8">
       ...
       <div>
        ...
        <p className="text-sm leading-relaxed" style={{ color: MUTED }}>
         Zential Pure is a newer brand. We do not have the volume of independent third-party reviews that FOREO has accumulated. If external social proof is your primary purchase criterion, acknowledge that clearly. We offer a 30-day money-back guarantee in its place: if it has not earned its place, return it.
        </p>
       </div>
      </div>
     </div>
