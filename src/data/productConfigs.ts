...
export const productConfigs: Record<string, ProductConfig> = {
 ...
 "lifting-and-tightening-face-introducer": {
  ...
  problemReframe: {
   ...
   closing: "EMS. Microcurrent. Thermal. In that order.",
  },
  techCards: [
  ...
  ritualSteps: [
   ...
   { step: "02", title: "Stimulate", desc: "Select EMS for muscle tone or microcurrent for finer re-education. 3–5 minutes. The 45°C thermal is active throughout." },
