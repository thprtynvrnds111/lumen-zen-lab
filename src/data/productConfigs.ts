...
export const productConfigs: Record<string, ProductConfig> = {
  ...
  "lifting-and-tightening-face-introducer": {
    ...
    studyCards: [
      ...
      { technology: "Microcurrent", studyTitle: "The Effects of Electric Currents on ATP Generation, Protein Synthesis, and Membrane Transport in Rat Skin", journal: "Clinical Orthopaedics and Related Research, 1982", url: "https://scholar.google.com/scholar?q=microcurrent+ATP+skin+cells" },
      { technology: "Ion Infusion", studyTitle: "Iontophoresis-Driven Porous Microneedle Array Patch for Active Transdermal Drug Delivery", journal: "Acta Biomaterialia, 2021", url: "https://scholar.google.com/scholar?q=iontophoresis+transdermal+skin" },
    ],
    contraindications: [
      "You have a pacemaker or implanted electronic device",
      "You are pregnant",
  ...
  "color-light-import-micro-current-vibration-massager": {
    ...
    faqs: defaultDeviceFaqs,
    studyCards: [
      { technology: "High Frequency", studyTitle: "High-Voltage Pulsed Current Electrical Stimulation in Wound Treatment", journal: "Advances in Wound Care, 2014", url: "https://scholar.google.com/scholar?q=high+frequency+electrical+skin+ozone" },
      { technology: "Antibacterial", studyTitle: "Ozone Therapy for Dermatological Conditions: A Systematic Review", journal: "Journal of Clinical and Aesthetic Dermatology, 2022", url: "https://scholar.google.com/scholar?q=high+frequency+electrical+skin+ozone" },
      { technology: "Collagen Stimulation", studyTitle: "Collagen Remodeling After 585-nm Pulsed Dye Laser Irradiation", journal: "Dermatologic Surgery, 2003", url: "https://scholar.google.com/scholar?q=high+frequency+electrical+skin+ozone" },
      { technology: "Multi-Mode Therapy", studyTitle: "Electromagnetic Muscle Stimulation: A Retrospective Study", journal: "Journal of Cosmetic Dermatology, 2022", url: "https://scholar.google.com/scholar?q=high+frequency+electrical+skin+ozone" },
    ],
    contraindications: [
      "You have a pacemaker or implanted electronic device",
      "You are pregnant",
  ...
  "electric-micro-current": {
    ...
    studyCards: [
      { technology: "EMS", studyTitle: "Neuromuscular Electrical Stimulation for Facial Wrinkles and Sagging", journal: "Journal of Cosmetic Dermatology, 2024", url: "https://scholar.google.com/scholar?q=electrical+muscle+stimulation+facial" },
      { technology: "Microcurrent", studyTitle: "The Effects of Electric Currents on ATP Generation, Protein Synthesis, and Membrane Transport in Rat Skin", journal: "Clinical Orthopaedics and Related Research, 1982", url: "https://scholar.google.com/scholar?q=microcurrent+ATP+skin+cells" },
      { technology: "Ion Drive", studyTitle: "Iontophoresis-Driven Porous Microneedle Array Patch for Active Transdermal Drug Delivery", journal: "Acta Biomaterialia, 2021", url: "https://scholar.google.com/scholar?q=iontophoresis+transdermal+skin" },
      { technology: "Micro-Vibration", studyTitle: "Low-Frequency Vibrotherapy Improves the Effectiveness of Manual Lymphatic Drainage", journal: "Journal of Clinical Medicine, 2018", url: "https://scholar.google.com/scholar?q=sonic+vibration+skin+absorption" },
    ],
    contraindications: [
      "You have a pacemaker or implanted electronic device",
      "You are pregnant",
  ...
  "facial-beauty-tools-and-ems-beauty-equipment": {
    ...
    studyCards: [
      { technology: "EMS", studyTitle: "Neuromuscular Electrical Stimulation for Facial Wrinkles and Sagging", journal: "Journal of Cosmetic Dermatology, 2024", url: "https://scholar.google.com/scholar?q=electrical+muscle+stimulation+facial" },
      { technology: "Precision EMS", studyTitle: "Use of a Neuromuscular Electrical Stimulation Device for Facial Muscle Toning", journal: "Journal of Cosmetic Dermatology, 2012", url: "https://scholar.google.com/scholar?q=electrical+muscle+stimulation+facial" },
      { technology: "Pulse Mode", studyTitle: "Low-Frequency Vibrotherapy Improves the Effectiveness of Manual Lymphatic Drainage", journal: "Journal of Clinical Medicine, 2018", url: "https://scholar.google.com/scholar?q=sonic+vibration+skin+absorption" },
      { technology: "Thermal", studyTitle: "Collagen Remodeling After 585-nm Pulsed Dye Laser Irradiation", journal: "Dermatologic Surgery, 2003", url: "https://scholar.google.com/scholar?q=thermal+therapy+skin+collagen" },
    ],
    contraindications: [
      "You have a pacemaker or implanted electronic device",
  ...
  "portable-ems-microcurrent-facial-beauty-device": {
    ...
    faqs: defaultDeviceFaqs,
    studyCards: [
      { technology: "Ion Cleansing", studyTitle: "Iontophoresis-Driven Porous Microneedle Array Patch for Active Transdermal Drug Delivery", journal: "Acta Biomaterialia, 2021", url: "https://scholar.google.com/scholar?q=iontophoresis+transdermal+skin" },
      { technology: "EMS + Microcurrent", studyTitle: "Neuromuscular Electrical Stimulation for Facial Wrinkles and Sagging", journal: "Journal of Cosmetic Dermatology, 2024", url: "https://scholar.google.com/scholar?q=electrical+muscle+stimulation+facial" },
      { technology: "LED Spectrum", studyTitle: "Low-Level Laser (Light) Therapy and Photobiomodulation", journal: "Photomedicine and Laser Surgery, 2014", url: "https://scholar.google.com/scholar?q=LED+light+therapy+skin+rejuvenation" },
      { technology: "Nutrient Infusion", studyTitle: "Iontophoresis-Driven Porous Microneedle Array Patch for Active Transdermal Drug Delivery", journal: "Acta Biomaterialia, 2021", url: "https://scholar.google.com/scholar?q=iontophoresis+transdermal+skin" },
    ],
    contraindications: [
      "You have a pacemaker or implanted electronic device",
      "You are pregnant",
