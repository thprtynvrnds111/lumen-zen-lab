...
const bundles: Bundle[] = [
 {
  ...
  items: [{ handle: "face-introducer", name: "Face Introducer" }],
  total: DEVICE_PRICE,
  highlight: false,
 ...
 },
 {
  ...
  tagline: "Most chosen",
  items: [
   { handle: "face-introducer", name: "Face Introducer" },
   { handle: "restore-gel", name: "Collagen Conductive Gel" },
  ],
 ...
 },
 {
  ...
  items: [
   { handle: "face-introducer", name: "Face Introducer" },
   { handle: "restore-gel", name: "Collagen Conductive Gel" },
   { handle: "restore-pads", name: "PDRN Recovery Pads" },
  ],
